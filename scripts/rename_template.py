...
if __name__ == "__main__":
    ...
    if proceed.lower() == "y":
        ...
        os.rename(
            os.path.join(root_dir_path, "source", old_name, old_name),
            os.path.join(root_dir_path, "source", old_name, new_name),
        )
        os.rename(
            os.path.join(root_dir_path, "source", old_name), os.path.join(root_dir_path, "source", new_name)
        )
